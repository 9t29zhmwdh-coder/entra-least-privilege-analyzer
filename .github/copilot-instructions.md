# Copilot Instructions for Entra Least-Privilege Analyzer

Read-only Rust CLI that connects to Microsoft Graph API to analyze Entra ID privilege configurations, detecting over-privileged accounts, role overlap and PIM gaps. Entirely read-only, no data leaves the machine.
